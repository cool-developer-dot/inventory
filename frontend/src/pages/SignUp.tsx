    ...
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center px-4 pt-24">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-extrabold text-navy-800 mb-2">Create your account</h1>
          <p className="text-neutral-500">Start managing your inventory today</p>
        </div>
        ...
        <p className="text-center text-sm text-neutral-500 mt-8">
          ...
          <Link to="/signin" className="font-semibold text-navy-800 hover:text-navy-hover">
            Sign in
          </Link>
        </p>
      </div>
